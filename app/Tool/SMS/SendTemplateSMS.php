...
class SendTemplateSMS
{
    ...
    private $accountSid= '8aaf07085967549b01596782aae20037';

    //主帐号令牌,对应官网开发者主账号下的 AUTH TOKEN
    private $accountToken= '3023df3610c54bf282798b221129bd14';

    //应用Id，在官网应用列表中点击应用，对应应用详情中的APP ID
    //在开发调试的时候，可以使用官网自动为您分配的测试Demo的APP ID
    private $appId='8aaf07085967549b01596782ab58003c';
