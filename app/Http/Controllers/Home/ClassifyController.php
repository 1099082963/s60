...
//        dd(count($bookrolls->toArray()));
            if(count($bookrolls->toArray())>0){
                ...
                if(count($bookchapters)>0){
                    ...
                    return view('home.classify.details')->with('i',1)->with('j',1)->with('hotbooks',$hotbooks)->with('data', $data)->with('name', $name)->with('newcollers', $newcollers)->with('status',$status)->with('do',1)->with('bookrolls',$bookrolls);
                }
...
//            return view('home.classify.details')->with('data', $data)->with('name', $name)->with('newcollers', $newcollers)->with('status',$status)->with('do',1);
...
//            return view('home.classify.details')->with('data', $data)->with('name',$name)->with('do',2);
        }

        //-----------------hewei结束---------------------------------
        /*$comment = homeUser::join('comment','user.id','comment.uid')->where('book_id',$id)->paginate(2);
