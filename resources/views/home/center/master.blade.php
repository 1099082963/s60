            ...
            <div class="body">
                ...
                <div class="aside">
                    ...
                    <div class="user-card">
                        ...
                        <a href="{{url('home/user/info')}}">
                            @yield('icon')
                        </a>
                        <div class="user-info">
                            <a href="" class="user-uname" target="_blank">@yield('username','文库新人')</a>
        ...
        $('.uc-nav li').click(function(){
            switch($(this).html()){
                ...
                case '账户充值':
                    ...
                    $.ajax({
                        url: '{{url('center/Money/usermoney')}}',
                        type: 'get',
                        success: function (data){
                            $('#maina').empty().append(data);
                        }
