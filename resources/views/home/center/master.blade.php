...
<div class="container menu-group">
    ...
    {{--<script type="text/javascript" src="/home/css/centermarster.js"></script>--}}
    <div id="bd" class="bd">
                ...
                <div class="aside">
                    ...
                    <div class="user-card">
                        ...
                        <a href="" target="_blank">
                            <img class="user-avatar" src="https://gss0.bdstatic.com/7Ls0a8Sm1A5BphGlnYG/sys/portraitn/item/90cecec4bfe2d0c2c8cbc37d" alt="文库新人">
                        </a>
                        <div class="user-info">
                            <a href="" class="user-uname" target="_blank">文库新人</a>
                        </div>
                    ...
                    <ul class="uc-nav">
                        ...
                        <li class="ggg" style="float: none;height: 61px;">文库VIP</li>
                        <li class="ggg" style="float: none;height: 61px;">我的兑换码</li>
                        <li class="ggg" style="float: none;height: 61px;">我的代金券</li>

                    </ul>
                    <div class="side-qr">
                            <img src="//wkstatic.bdimg.com/static/yduc/layout/read_uc_layout/images/qr_47df8c9.png" />

                        <span class="qr-text">扫描手机同步阅读</span>
                    </div>
...
<script>
    $(function(){
        $('.uc-nav li').click(function(){
            switch($(this).html()){
                //请求一个string响应
                case '我的图书':
                    $(this).addClass('curr').siblings().removeClass('curr');
                    $.ajax({
                        url:'center/myBooks/my',
                        type:'get',
