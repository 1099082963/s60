                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{url('home/buy')}}"><button type="button" class="btn">加入购物车</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="db-left-main clearfix">
                    ...
                    <div class="controduct clearfix">
                        ...
                        <div class="hd select-title clearfix" style="border-bottom:1px solid #999;position: relative">
                            ...
                            <a href="#book-comment" class="select-ti"><span class="select-item-border">评论&nbsp;<span style="color:#999;">(0)</span></span></a>
                        </div>
                                                ...
                                                {{--@if(session('phone'))--}}
                                                    ...
                                                    {{--@endif--}}
                                                        {{--@foreach($perfect as $zan)--}}
                                                            {{--@if($zan->comment_id==$com->id)--}}
                                                                {{--<button class="perfect">{{$zan['perfect']==1?'已赞':'赞'}}</button>--}}
                                                                {{--@else--}}
                                                                {{--<button class="perfect">赞</button>--}}
                                                            {{--@endif--}}
                                                        {{--@endforeach--}}
